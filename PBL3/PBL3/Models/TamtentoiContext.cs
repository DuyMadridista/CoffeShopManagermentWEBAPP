...
namespace PBL3.Models
{
    public partial class TamtentoiContext : DbContext
    {
        ...
        public List<SpLoaiMon> StatisticByLoaiMonId(int month, int year)
        {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=SQL5104.site4now.net;Database=db_a9e758_duy432003;User Id=db_a9e758_duy432003_admin;Password=duy432003;");
                //"Server=LAPTOP-CUA-DUY\\SQLEXPRESS02;Database=tamtentoiDB2;Trusted_Connection=True;Integrated Security=True;"
            }
        }
